# Rotary Triple Press Reboot

## Purpose
Defines requirements for the rotary switch triple-press gesture that reboots the Pi host.

## Capability

`rotary-triple-press-reboot`: Triple pressing the rotary knob switch triggers a host Pi reboot, providing a hands-on way to restart the device without SSH.
